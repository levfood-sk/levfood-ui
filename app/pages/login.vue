      ...
      <div class="space-y-4">
        ...
        <div class="space-y-3">
          <UButton
            ...
            variant="outline"
            :loading="loading"
            @click="authClient.signIn.social({ provider: 'google', callbackURL: '/dashboard' })"
          >
            <template #leading>
          ...
          <UButton
            ...
            size="lg"
            :loading="loading"
            @click="authClient.signIn.social({ provider: 'apple', callbackURL: '/dashboard' })"
          >
            <template #leading>
